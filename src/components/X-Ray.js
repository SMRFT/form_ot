...
const XRay = () => {
  ...
  const [numberOfReportingErrorsRemarks, setNumberOfReportingErrorsRemarks] = useState('');
  const [numbercaseperformed, setnumbercaseperformed]= useState('');
  ...
  return (
    <StyledContainer style={{ maxWidth: '600px' }} className="NumericalData">
       <h2 className="text-center">X-Ray</h2>
       ...
       <Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          <Form.Group controlId="numberOfTestsPerformed">
            ...
            required
              type="text"
              value={numbercaseperformed}
              onChange={(e) => {setnumbercaseperformed(e.target.value);handleChange(e);}}
            />
            <Form.Control.Feedback type="invalid">
            Please fill out this field
          </Form.Control.Feedback>
