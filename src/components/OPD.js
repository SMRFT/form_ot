...
const OPD=()=>{
  ...
  const [SumofTimeTakenforInitialthAssessment, setSumofTimeTakenforInitialthAssessment]=useState('');
  const [TotalNumberofop, setTotalNumberofop]=useState('');
  const [sumofTimeTakenforconsultation, setsumofTimeTakenforconsultation]=useState('');
  ...
  const [error, setError] = useState('');
    const [formData, setFormData] = useState({
        ...
        name: '',
        selectedDate:'',
        SumofTimeTakenforInitialthAssessment:'',
    ...
    return (
      ...
      <br/>
         <Form noValidate validated={validated} onSubmit={handleSubmit}>
          ...
          <Row className="mb-3">
            <Form.Group controlId="SumofTimeTakenforInitialthAssessment">
                  <Form.Label >
                  ...
                  required
                  type="text"
                  value={SumofTimeTakenforInitialthAssessment}
                  onChange={(e) => {setSumofTimeTakenforInitialthAssessment(e.target.value);handleChange(e);}} />
          ...
          <Row className="mb-3">
            <Form.Group controlId="sumofTimeTakenforconsultation">
                  ...
                  required
                  type="text"
                  value={sumofTimeTakenforconsultation}
                  onChange={(e) => {setsumofTimeTakenforconsultation(e.target.value);handleChange(e);}} />
                  <Form.Control.Feedback type="invalid">
                  Please fill out this field
                </Form.Control.Feedback>
              </Form.Group>
          ...
          <Row className="mb-3">
          <Form.Group controlId="TotalNumberofop">
                <Form.Label >
                Total Numberof OP
                </Form.Label>
                <Form.Control
                required
                type="text"
                value={TotalNumberofop}
                onChange={(e) => {setTotalNumberofop(e.target.value);handleChange(e);}} />
                <Form.Control.Feedback type="invalid">
                 Please fill out this field
              </Form.Control.Feedback>
            </Form.Group>
